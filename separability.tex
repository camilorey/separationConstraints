...
\\\\
In addition, Their boundary is defined by the hyperplane with normal vector $\vec{w}$ \emph{translated} by the bias $b$ \cite{convexOptimizationBoyd,florenzano2001ConvexAnalysis,Burges1998TutorialOnSVMForPatternRecognition}.
